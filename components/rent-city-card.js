...
const RentCityCard = ({ url }) => {
  ...
  return (
    ...
    >
      <div className=" h-6 flex flex-row items-end justify-center gap-[32px]">
        <div className="flex flex-row items-start justify-end gap-[8px]">
          <img
            className="relative w-6 h-6"
            alt=""
            src="https://yeray1412.github.io/realState/mappin.svg"
          />
        ...
        <div className="flex flex-row items-start justify-end gap-[8px]">
          <img
            className="relative w-6 h-6"
            alt=""
            src="https://yeray1412.github.io/realState/arrowsout2.svg"
          />
