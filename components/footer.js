...
const Footer = () => {
  return (
    <div className="w-[100%] flex flex-row p-[50px] items-start justify-start md:w-auto md:flex-row sm:flex-col">
        ...
        <div className="w-[312px] h-[300px] flex flex-col items-start justify-start gap-[20px] text-center text-primary-500 font-body-large-400">
          <div className="flex flex-row items-center justify-center gap-[8px]">
            <img
              className="w-11 h-11"
              alt="houseLine"
              src="https://yeray1412.github.io/realState/houseline.svg"
            />
          ...
          <div className="w-[304px] mt-3 flex flex-row items-center justify-between">
            <div className="rounded bg-primary-50 flex flex-col p-3.5 items-center justify-center">
              <img
                className="relative w-5 h-[21.67px]"
                alt="img"
                src="https://yeray1412.github.io/realState/social-media-logo.svg"
              />
            </div>
            <div className="rounded bg-primary-50 flex flex-col p-3.5 items-center justify-center">
              <img
                ...
                alt="img"
                src="https://yeray1412.github.io/realState/social-media-logo1.svg"
              />
            </div>
            <div className="rounded bg-primary-50 flex flex-col p-3.5 items-center justify-center">
              <img
                ...
                alt="img"
                src="https://yeray1412.github.io/realState/social-media-logo2.svg"
              />
            </div>
            <div className="rounded bg-primary-50 flex flex-col p-3.5 items-center justify-center">
              <img
                className="relative w-5 h-5 overflow-hidden"
                alt=""
                src="https://yeray1412.github.io/realState/social-media-logo3.svg"
              />
            </div>
            <div className="rounded bg-primary-50 flex flex-col p-3.5 items-center justify-center">
              <img
                className="relative w-5 h-5 overflow-hidden"
                alt="img"
                src="https://yeray1412.github.io/realState/social-media-logo4.svg"
              />
            </div>
          </div>
        </div>
