      ...
      <div className="flex-1 flex flex-col py-0 px-2.5 box-border items-center justify-start gap-[40px] max-w-[900px]">
        ...
        <div className="self-stretch rounded-xl bg-gray-white shadow-[0px_0px_24px_rgba(0,_0,_0,_0.03)] flex flex-col py-7 px-[30px] items-center justify-start gap-[17px] text-left text-5xl text-darkslategray font-poppins">
          ...
          <div className="self-stretch flex flex-col items-center justify-start gap-[10px]">
            ...
            />
            <textarea
              className="bg-[transparent] font-roboto text-base self-stretch rounded box-border h-[105px] flex flex-col p-3 items-start justify-start border-[1px] border-solid border-gray1"
              placeholder="Comments or questions"
            />
            <button className="cursor-pointer [border:none] p-0 bg-primary-500 rounded w-[222px] h-[46px] flex flex-col items-center justify-center hover:bg-darkslateblue lg:bg-blueviolet sm:self-stretch sm:w-auto sm:max-w-full">
